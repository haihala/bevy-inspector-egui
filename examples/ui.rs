        ...
        .with_children(|parent| {
            ...
            parent
                .spawn(NodeBundle {
                    ...
                    background_color: BackgroundColor(Color::rgb(0.4, 0.4, 1.0)),
                    ..Default::default()
                })
                .with_children(|parent| {
                    parent.spawn(NodeBundle {
                        ...
                        background_color: BackgroundColor(Color::rgb(0.8, 0.8, 1.0)),
                        ..Default::default()
                    });
                });
                    ...
                    parent
                        ...
                        .with_children(|parent| {
                            parent.spawn(NodeBundle {
                                ...
                                background_color: BackgroundColor(Color::rgb(1.0, 0.3, 0.3)),
                                ..Default::default()
                            });
                            parent.spawn(NodeBundle {
                                style: Style {
                            ...
                            parent.spawn(NodeBundle {
                                ...
                                background_color: BackgroundColor(Color::rgb(1.0, 0.7, 0.7)),
                                ..Default::default()
                            });
                            // alpha test
                            parent.spawn(NodeBundle {
                                ...
                                background_color: BackgroundColor(Color::rgba(1.0, 0.9, 0.9, 0.4)),
                                ..Default::default()
                            });
                        });
                });
